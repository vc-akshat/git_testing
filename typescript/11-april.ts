...
// class Book{
//     private _title: string = "akshat";
//     private _author: string = "hello";
...
//     set bookIsbn(isbn: string){
//         let regEx = /\d{13}$/g;
//         if(isbn.match(regEx)){
//             let part1 = isbn.slice(0,4);
//             let part2 = isbn.slice(4,5);
//             let part3 = isbn.slice(5,9);
//             let part4 = isbn.slice(9,13);
//             let getAns = `${part1}-${part2}-${part3}-${part4}`;
//             this._isbn = getAns;
//         }
//         else{
